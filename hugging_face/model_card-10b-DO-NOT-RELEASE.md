...
https://huggingface.co/nvidia/alpamayo-r1-10b (Hugging Face model repository)
TODO: delete it before release
...
Hugging Face 12/02/2025 via https://huggingface.co/nvidia/alpamayo-r1-10b
...
**Number of model parameters:** 1.0 x 10^10
...
- NVIDIA GPUs with sufficient memory to load 10B parameter model (minimum 1 GPU with 24GB+ VRAM)
...
TODO: update the number when have 10B model. Reminder not to publish.
...
- Minimum: 1 GPU with 24GB+ VRAM (e.g., NVIDIA RTX 4090, A5000, or equivalent)
