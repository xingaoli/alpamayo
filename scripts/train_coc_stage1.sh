...
CONFIG_NAME=sft_coc_stage1
STAGE2_CKPT=${STAGE2_CKPT:-/home/xingao/code/NVlabs-alpamayo/alpamayo/ckpts/Alpamayo-R1-10B-from-1.5}
...
torchrun --nproc_per_node=${NUM_GPUS} \
    ...
    model.vlm_name_or_path=ckpts/Qwen3-VL-8B-Instruct-config \
    "$@"
