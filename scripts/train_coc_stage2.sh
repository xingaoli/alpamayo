...
STAGE2_NO_COC_CKPT=${STAGE2_NO_COC_CKPT:-/home/xingao/code/Alpamayo/ckpts/Alpamayo-R1-10B-from-1.5}
STAGE1_COC_CKPT=${STAGE1_COC_CKPT:-/home/xingao/code/Alpamayo/outputs/output_coc_stage1/checkpoint-50}
